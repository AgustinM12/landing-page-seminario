...
export const HorizontalCardComponent = ({ img = "", title = "", cardTitle = "", description = "", icon = "", orientation = 0, children = "" }) => {
    return (
        ...
        <div className={`h-72 w-fit max-w-full flex group overflow-hidden ${!orientation && "flex-row-reverse"}`}>
            ...
            >
                <h2 style={{ textShadow: '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000' }} className="font-bold px-5 text-xl pt-[55%] z-20 relative textShadow">{cardTitle}</h2>
