...
const cursos = [
  { name: 'Lenguajes de Programación', description: 'Descubre el arte de crear con código y conquista el mundo digital', href: '/login', icon: CodeBracketIcon },
  { name: 'Bases de Datos', description: 'Domina el poder de los datos y construye el futuro de la información', href: '#', icon: CircleStackIcon },
  { name: 'Ciber Seguridad', description: 'Protege como un héroe: ¡salva datos y mantén la seguridad en línea!', href: '#', icon: LockClosedIcon },
  { name: 'Inteligencia Artificial', description: 'Da vida a la inteligencia: crea sistemas que aprendan y sorprendan', href: '#', icon: SparklesIcon },
  { name: 'Frontend y Backend', description: 'Diseña la experiencia, controla la magia: convierte ideas en realidad digital', href: '#', icon: ArrowPathIcon }
];

const callsToAction = [
  { name: 'Quiero recibir más información sobre los cursos', href: '#', icon: PlayCircleIcon },
];
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-8">
          <Popover className="relative">
            ...
            <Transition
              ...
              enterFrom="opacity-1 translate-y-1"
                  ...
                  {cursos.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-auto">
                        <a href={item.href} className="block font-semibold text-white hover:text-gray-900">
                          {item.name}
          ...
          <a href="#" className="text-sm font-semibold leading-6 text-white button hover:text-cyan-400 ">
            Sobre Nosotros
          </a>
          <a href="#" className="text-sm font-semibold leading-6 text-white button hover:text-cyan-400 ">
            Ayuda
